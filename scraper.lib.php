...
function spcurl($url,$params=false) {
    ...
    curl_setopt ($chnd, CURLOPT_COOKIESESSION, true );
    // curl_setopt ($chnd, CURLOPT_COOKIEJAR,"gvCookies.txt");
    curl_setopt ($chnd, CURLOPT_COOKIEFILE,"gvCookies.txt");
    // curl_setopt ($chnd, CURLOPT_SSL_VERIFYPEER, false);
...
function curl($url,$post = FALSE) {
    ...
    curl_setopt ($ch, CURLOPT_FOLLOWLOCATION, TRUE); 
    curl_setopt ($ch, CURLOPT_RETURNTRANSFER, TRUE);
    curl_setopt ($ch, CURLOPT_USERAGENT, 'User-Agent:Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.98 Safari/537.36');
    ...
    $defaultSpanText = DEFAULT_SPAN_TEXT)
{
    ...
    //     $maxLen
    // );
    $contents = curl($url,$use_include_path);
